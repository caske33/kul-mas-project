...
\begin{table}
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Independent variables and their ranges}
\end{table}
\begin{table}
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Dependant variables and their meaning\commentY{wat doen we met dependant variables die in csv voorkomen maar niet in de grafieken?}}
\end{table}
\begin{table}
	\begin{center}
		\begin{tabular}{ p{0.4\columnwidth}p{0.5\columnwidth} }
...
\taskS{euro-symbool wordt niet goed weergegeven op y-label van profit, EUR proberen?}
