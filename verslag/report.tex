...
\begin{table}[htp]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Dependant variables and their meaning\commentY{wat doen we met dependant variables die in csv voorkomen maar niet in de grafieken? \commentV{niet vermelden zou ik zeggen }}}
	\label{tbl:dependent}
\end{table}
\begin{table}[htp]
	\begin{center}
