...
\outline{\begin{itemize}
    ...
    \end{itemize}}
\subsection{Results}
\commentY{Ook 95 \% Confidence interval (CI) op grafieken? Prof is daar precies fan van => Misschien beter om te doen. Ik ben niet 100\% zeker van correctheid, maar misschien wel, omdat CI daar slaagt op één test, niet op het verschil tussen 2 testen.}
\subsection{Analysis}
